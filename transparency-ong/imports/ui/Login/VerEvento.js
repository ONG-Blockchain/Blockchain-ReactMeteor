...
class VerEvento extends TrackerReact(React.Component) {
    ...
    async donateToken(my_privkey, myAddress, destAddress, tokensDonar){
        ...
        this.getBalanceEvento(this.state.destAddress);
    ...
    async getBalanceEvento(myAddress){
        //Para usar en un boton: onClick={this.getBalance.bind(this, this.state.myAddress)}
        var abiArray = [{
            "constant": true,
            "inputs": [],
        ...
        var balance = await contract.methods.balanceOf(myAddress).call();
        console.log(`Balance before send: ${balance}`);
        this.setState({ tokensEvento: balance });
    }
    ...
    componentDidMount(){
        ...
        Meteor.setTimeout(function(){
            ...
            self.setState({ my_privkey: Meteor.user().profile.private });
            self.setState({ myAddress: Meteor.user().profile.public });
            self.setState({ destAddress: eventoObj.Public });
            self.getBalance(self.state.myAddress);
            self.getBalanceEvento(self.state.destAddress);
        }, 300);
            ...
            return (
                <div>
                    ...
                    <div className="divStyle" id="prueba">
                        <p className="textPrize">Gracias por Donar!</p>
                    ...
                    <div className="container contenedor">
                        ...
                        <div className="row">
                            <div className="col alineamiento">
                                ...
                                <label className="titulodescripcion pad">{this.state.tokensEvento}</label>
                            </div>
                        </div>
                        <div className="row">
                            <div className="col alineamiento">
                        ...
                        <div className="row">
                            <div className="col centrarbotones">
                                <button className="btn btn-secondary button1" onClick={this.showModal.bind(this)}>Donar</button>
